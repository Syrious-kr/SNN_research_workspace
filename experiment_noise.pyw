...
plt.title(f'Ablation Study (Noise \u03c3={HfO2_Device.NOISE_SIGMA}, Res: {target_resolution}, 5 Seeds)'); plt.xlabel('Epoch'); plt.ylabel('Accuracy'); plt.legend(); plt.grid(True)
plt.savefig('ablation_study_noise.png')
