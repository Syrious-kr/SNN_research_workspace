...
plt.title(f'Ablation Study (Batch 1024, Res: {target_resolution}, 5 Seeds)'); plt.xlabel('Epoch'); plt.ylabel('Accuracy'); plt.legend(); plt.grid(True)
plt.savefig('ablation_study_1024.png')
