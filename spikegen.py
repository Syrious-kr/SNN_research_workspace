...
from spikingjelly.activation_based import neuron, layer, functional, surrogate, monitor
...
def run_ablation_study(modes, res_steps, seeds, epochs=100):
    ...
    for mode in modes:
        ...
        for seed in seeds:
            ...
            for epoch in range(epochs):
                ...
                total_spikes = sum(m.sum().item() for m in spike_monitor.records)
...
ablation_data = run_ablation_study(baselines, target_resolution, [0, 1, 2, 3, 4], epochs=100)